...
class ScanNetData:
    ...
    def __init__(self, root_path, split="train.sh"):
        ...
        assert split in ["train.sh", "val", "test"]
    ...
    def get_axis_align_matrix(self, idx):
        matrix_file = osp.join(
            self.root_dir, "scannet_instance_data", f"{idx}_axis_align_matrix.npy"
        )
    ...
    def get_infos(self, num_workers=4, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            pts_filename = osp.join(
                self.root_dir, "scannet_instance_data", f"{sample_idx}_vert.npy"
            )
...
class ScanNetSegData:
    ...
    def __init__(
        self, data_root, ann_file, split="train.sh", num_points=8192, label_weight_func=None
    ):

...
from data_converter import nuscenes_converter_ext as nuscenes_converter
...
def nuscenes_data_prep(
    root_path, can_bus_root_path, info_prefix, version, dataset_name, out_dir, max_sweeps=10
):
...
def waymo_data_prep(root_path, info_prefix, version, out_dir, workers, max_sweeps=5):
    ...
    for i, split in enumerate(splits):
        ...
        converter = waymo.Waymo2KITTI(
            load_dir, save_dir, prefix=str(i), workers=workers, test_mode=(split == "test")
        )
        converter.convert()
...
parser.add_argument(
    "--root-path", type=str, default="./data/kitti", help="specify the root path of dataset"
)
parser.add_argument(
    "--canbus", type=str, default="./data", help="specify the root path of nuScenes canbus"
)
parser.add_argument(
    "--version",
    type=str,
...
parser.add_argument(
    "--out-dir", type=str, default="./data/kitti", required="False", help="name of info pkl"
)

...
if __name__ == '__main__':
    nusc = NuScenes(version='v1.0-trainval', dataroot='/home/can/Desktop/research/sensorfusion/data/nuscenes/full', verbose=True)
    ...
    bevformer_results = mmcv.load('/home/can/Desktop/research/sensorfusion/test/bevformer_small/RED_rain/pts_bbox/results_nusc.json')

...
customrainval = \
    ['scene-0625','scene-0626','scene-0627','scene-0629','scene-0630','scene-0632','scene-0633','scene-0634','scene-0635',
     'scene-0636','scene-0637','scene-0638','scene-0904','scene-0905','scene-0906','scene-0907','scene-0908','scene-0909',
     'scene-0910','scene-0911','scene-0912','scene-0913','scene-0914','scene-0915','scene-1060','scene-1065','scene-1067']
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    scene_splits = {'train': train, 'val': val, 'test': test,
                    ...
                    'customrainval':customrainval, 'customnightval':customnightval}

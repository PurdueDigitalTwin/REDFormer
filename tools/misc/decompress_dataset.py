...
parser.add_argument("--download_dir", type=str, default="/media/can/samsungssd/nuscenes/archive/")
parser.add_argument("--dest_dir", type=str, default="/media/can/samsungssd/nuscenes/full")
parser.add_argument(
    "--decompress_commands",
    type=str,
...
if __name__ == "__main__":
    nuscenes_data_decompression(
        args.download_dir, args.dest_dir, args.decompress_commands, args.prefix
    )

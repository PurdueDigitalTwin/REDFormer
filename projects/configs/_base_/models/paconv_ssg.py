...
model = dict(
    ...
    decode_head=dict(
        ...
        fp_channels=((768, 256, 256), (384, 256, 256), (320, 256, 128), (128 + 6, 128, 128, 128)),
        channels=128,
        dropout_ratio=0.5,
    ...
    loss_regularization=dict(type="PAConvRegularizationLoss", reduction="sum", loss_weight=10.0),

model = dict(
    ...
    bbox_head=dict(
        ...
        center_loss=dict(type="SmoothL1Loss", reduction="sum", loss_weight=1.0),
        dir_class_loss=dict(type="CrossEntropyLoss", reduction="sum", loss_weight=1.0),
        dir_res_loss=dict(type="SmoothL1Loss", reduction="sum", loss_weight=1.0),
        size_res_loss=dict(type="SmoothL1Loss", reduction="sum", loss_weight=1.0),
        corner_loss=dict(type="SmoothL1Loss", reduction="sum", loss_weight=1.0),
